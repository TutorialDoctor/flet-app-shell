...
def Settings():
    def handle_click(e):
        set_page_state({"name": "Settings Page Clicked"})

    page_state, set_page_state = ft.use_state({"name": "Settings Page"})
    ...
    return PageLayout(title="Settings", left_nav_items=left_nav_items, content=content)